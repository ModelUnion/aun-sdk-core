...
- `docs/INDEX.md` L7-34：根级文档地图。

### Step 2：按主题读根级 Layer 2

- 测试与 E2E：`docs/INDEX.md` L40-47。
- SDK 使用与协议：`docs/INDEX.md` L49-61。
- Service Proxy 与服务暴露：`docs/INDEX.md` L63-68。
- 诊断与可观测性：`docs/INDEX.md` L70-76。
- E2EE 与跨语言一致性：`docs/INDEX.md` L78-82。

### Step 3：需要判断文档价值时读 Layer 3 摘要

- `docs/INDEX.md` L86-170：重点文档摘要。
