...
- `docs/INDEX.md` L7-22：根级文档地图。

### Step 2：按主题读根级 Layer 2

- 测试与 E2E：`docs/INDEX.md` L28-34。
- SDK 使用与协议：`docs/INDEX.md` L36-41。
- 诊断与可观测性：`docs/INDEX.md` L43-47。
- E2EE 与跨语言一致性：`docs/INDEX.md` L49-53。

### Step 3：需要判断文档价值时读 Layer 3 摘要

- `docs/INDEX.md` L57-93：重点文档摘要。
...
| AUNClient 巨类拆分重构执行方案 | `docs/design/AUNClient拆分重构执行方案.md` L3-252、L253-668、L669-768 |
