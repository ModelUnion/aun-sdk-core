...
- `docs/INDEX.md` L7-26：根级文档地图。

### Step 2：按主题读根级 Layer 2

- 测试与 E2E：`docs/INDEX.md` L32-39。
- SDK 使用与协议：`docs/INDEX.md` L41-47。
- 诊断与可观测性：`docs/INDEX.md` L49-55。
- E2EE 与跨语言一致性：`docs/INDEX.md` L57-61。

### Step 3：需要判断文档价值时读 Layer 3 摘要

- `docs/INDEX.md` L65-117：重点文档摘要。
...
| Notify 在线轻量通知方案 | `docs/sdk/Notify通知方案.md` |
