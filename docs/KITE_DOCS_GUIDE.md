...
- `docs/INDEX.md` L7-25：根级文档地图。

### Step 2：按主题读根级 Layer 2

- 测试与 E2E：`docs/INDEX.md` L31-38。
- SDK 使用与协议：`docs/INDEX.md` L40-45。
- 诊断与可观测性：`docs/INDEX.md` L47-53。
- E2EE 与跨语言一致性：`docs/INDEX.md` L55-59。

### Step 3：需要判断文档价值时读 Layer 3 摘要

- `docs/INDEX.md` L63-111：重点文档摘要。
