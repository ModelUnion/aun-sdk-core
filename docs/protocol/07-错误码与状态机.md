...
| 错误码 | 说明 | 客户端处理 |
|--------|------|-----------|
| -33401 | Stream not found | 检查 stream_id |
| -33402 | Stream already closed | 不重试 |
| -33403 | Stream limit reached（活跃流数已达上限） | 等待其他流关闭后重试 |
| -33404 | Stream push token invalid | 检查 push_url |
| -33405 | Stream pull token invalid | 检查 pull_url |
| -33406 | Stream puller limit reached（拉流端数已达上限） | 稍后重试 |
| -33407 | Stream permission denied（非创建者执行受限操作） | 不重试 |
