...
| 分类 | 错误码 | 说明 |
|------|--------|------|
| **可重试** | -32010, -32101, -32151, -32154, -32163 | 临时状态，稍后可能恢复 |
| **不可重试** | -32001, -32003, -32004, -32100, -32102, -32103, -32104, -32175 | 永久性拒绝 |
| **需操作后重试** | -32002, -32005, -32013, -32150, -32164, -32172 | 需要先完成特定操作 |
...
| 状态 | 允许的方法 | 说明 |
|------|-----------|------|
| CONNECTED | initialize, auth.*（仅 gateway 预认证） | 刚建立 WebSocket |
